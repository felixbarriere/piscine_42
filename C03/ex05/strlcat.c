...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/07/05 15:47:46 by fbarrier          #+#    #+#             */
/*   Updated: 2021/07/06 10:49:56 by fbarrier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <unistd.h>
#include <stdio.h>
...
char	unsigned int ft_strlcat(char *dest, char *src, unsigned int size)
	{
	unsigned int i;
